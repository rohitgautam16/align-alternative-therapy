// src/components/admin-ui/AdminSongCard.jsx
import React from 'react';
import { Eye, CheckCircle, XCircle } from 'lucide-react';

export default function AdminSongCard({
  song,
  assigned = false,
  onView,
  onToggle,
    ...
    <div className="bg-gray-800 rounded-lg flex flex-col-reverse md:flex-row h-auto md:h-48 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col p-4 justify-between mt-4 md:mt-0 min-w-0">
        <div className="min-w-0 flex-1">
          <h4 className="font-medium text-lg md:text-xl text-white truncate mb-1">
            {song.title}
          </h4>
      ...
      <div className="flex-shrink-0 w-full md:w-48 h-48 md:h-full">
        <img
          src={song.image || song.artwork_filename || song.artworkUrl || ''}
          alt={song.title}
